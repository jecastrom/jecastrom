= Ironhack's Data BootCamp Courswork:
:toc:
:toc-title: 
:toc-placement!:
ifdef::env-github[]
...
|https://github.com/jecastrom?tab=stars[Repositories by Categories] |https://github.com/stars/jecastrom/lists/web-scraping-api-s-ironhack[Web Scraping & API's Ironhack]
|
|
|
|
